...
function EmptyState() {
  return (
    <section className="flex h-screen items-center">
      <div className="w-6/12 text-center py-12 mx-auto">
        <img
          style={{ height: '50%' }}
        ...
        <p className="text-lg text-gray-600 mt-4 mb-8 mx-auto text-center">
          It seems you don't have any class yet so let's go get them and grow
          your skills
        </p>
        <a
          target="_blank"
              ...
              <>
                <section className="flex flex-col mt-8">
                  ...
                  <p className="text-lg text-gray-600">
                    Continue learning to pursue uour dreams
                  </p>
                  <section className="flex flex-col mt-8">
